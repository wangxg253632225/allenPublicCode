package com.dongnaoedu.mvc.servlet;
...
import com.dongnaoedu.mvc.controller.TestController;
import com.dongnaoedu.mvc.service.impl.TestServiceImpl;
...
System.out.print("加载");
	...
	private void doIoc() {
		...
		TestServiceImpl testService = (TestServiceImpl) ioc.get("testService");
